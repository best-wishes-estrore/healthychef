        ...
        <ContentTemplate>
            <table>
                ...
                <tr>
                    ...
                    <td style="height: 100%; vertical-align: middle; width: 50px;" runat="server" id="checkboxForSelection">
                    ...
                    <td style="height: 100%; vertical-align: middle; width: 50px;" runat="server" id="listBoxForPreferencesAndIngredients">
                        <span style="display: inline-block; margin: 0 10px 0 10px">
                            <asp:Button CausesValidation="false" runat="server" Font-Bold="true" Font-Size="12px"
                                Width="90%" ID="btnPrefDeselectAll" Text="&lt;&lt;" ToolTip="Deselect All Items"
                                CommandName="PrefDeselectAll" Style="margin-top: 7px;" />
                            <asp:Button CausesValidation="false" runat="server" Font-Bold="true" Font-Size="12px"
                                Width="90%" ID="btnPrefDeselectSelected" Text="&lt;" ToolTip="Deselect Selected Items"
                                CommandName="PrefDeselectSelected" Style="margin-top: 7px;" />
                            <asp:Button CausesValidation="false" runat="server" Font-Bold="true" Font-Size="12px"
                                Width="90%" ID="btnprefSelectSelected" Text="&gt;" ToolTip="Selected Selected Items"
                                CommandName="prefSelectSelected" Style="margin-top: 7px;" />
                            <asp:Button CausesValidation="false" runat="server" Font-Bold="true" Font-Size="12px"
                                Width="90%" ID="btnprefSelectAll" Text="&gt;&gt;" ToolTip="Select All Items" CommandName="prefSelectAll"
                                Style="margin-top: 7px;" />
                        </span>
                    </td>

                    <td id="checkBoxSelectedItems" runat ="server">
                        <div class="block">
                        <asp:CheckBoxList runat="server" ID="lstSelectedItems"  Font-Size="10px" Width="200px" RepeatLayout="Table" ></asp:CheckBoxList>
                        </div>
                    </td>

                    <td id="listItemSelectedItems" runat ="server">
                        <asp:ListBox runat="server" ID="listBoxSelectedItems" Font-Size="10px" Width="300px"
                            SelectionMode="Multiple" Rows="12" />
                    </td>
