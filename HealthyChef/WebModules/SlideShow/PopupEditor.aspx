<%@ Page  validaterequest="false" Language="C#" AutoEventWireup="true" CodeBehind="PopupEditor.aspx.cs" Inherits="BayshoreSolutions.WebModules.SlideShow.PopupEditor" %>
<%@ OutputCache  NoStore="true" Location="None"%>
<%@ Register TagPrefix="FCKeditorV2" Namespace="FredCK.FCKeditorV2" Assembly="FredCK.FCKeditorV2" %>

<html>
<head id="Head1" runat=server>
<title>Slide Content Editor</title>
<style>
body {
...
<form id=elForm runat=server>
    <div style="text-align:center;margin:10px;">
		<table width=99%>
			...
			<tr>
				<td align="left">
			        Content Name: <asp:TextBox ID="txtContentName" runat="server" />
				</td>
				<td align="right">
					Link Url: <asp:TextBox ID="txtLinkUrl" runat="server" />
				</td>
				<td align="center">
